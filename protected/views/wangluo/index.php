 <?php 
      ...
      $courl=$this->createUrl('index',array('column_id'=>$column_id,'catalog_id'=>'xiaoyuan'));//column 默认的action或者catalog

?>
 <!-- banner --> 
 <div class="banner" >
   <img src="<?php echo Yii::app()->request->baseUrl; ?>/upload/banner/wangluo.png" alt="placeholder+image"></div>
 <!-- sub-content --> 
